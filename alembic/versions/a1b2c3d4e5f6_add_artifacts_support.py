...
down_revision: Union[str, Sequence[str], None] = 'b629d2878149'
...
def upgrade() -> None:
    ...
    op.add_column('executions', sa.Column('artifacts_count', sa.Integer(), nullable=False, server_default='0'))
    op.add_column('executions', sa.Column('artifacts_size_bytes', sa.Integer(), nullable=False, server_default='0'))
