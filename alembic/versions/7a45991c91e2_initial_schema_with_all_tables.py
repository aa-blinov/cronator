...
def upgrade() -> None:
    ...
    op.create_index('idx_script_versions_script_created', 'script_versions', ['script_id', 'created_at'], unique=False)
    op.create_index('idx_script_versions_script_version', 'script_versions', ['script_id', 'version_number'], unique=False)
